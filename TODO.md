...
[ ]We should add Bstool tab wich will use external tool called bstool.exe ( wich is exe file ) and integrate it so we can use it in same way we use telnet to get information in automated way