...
import { Upload, Plus, Trash2, Save, FolderOpen, Box, Loader2 } from 'lucide-react';
import DirBrowser from './DirBrowser';
import type { NodeConfig } from '../types/api';
...
export function NodesTabContent({ projectId, onNodesSaved, onScanNodes, scanning, scanResult, toolbarRef }: NodesTabContentProps) {
