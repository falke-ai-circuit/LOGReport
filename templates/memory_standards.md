...
## 📋 Overview
Memory entities require consistent hierarchical structuring for discoverability, reusability, and relationships | Defines naming conventions, hierarchical rules, and connection patterns | **MANDATORY METADATA**: All entities must have complete metadata for tracking and obsolete detection

### 📊 MANDATORY Metadata Fields
**REQUIRED FOR ALL ENTITIES**: `created_date` | `last_modified` | `last_accessed` | `reference_count` | `usage_count` | `access_log_enabled` | `hierarchy_path` | `content_hash` | `similarity_index` | `obsolete_check_date` | **TRACKING**: Auto-generated by memory system | Updated on every access/modification | Used for obsolete detection
...
metadata:
  ...
  hierarchy_path: "Entity→Cluster→Domain→Type"
  content_hash: "sha256_hash"
  similarity_index: float
  obsolete_check_date: YYYY-MM-DD_HHMMSS
```
