...
2. Read `skills/INDEX.md` → pre-load: pyqt5-desktop + docker
...
| skill | pyqt5-desktop, docker, testing, debugging, documentation |
...
| Trigger | Skill |
|---------|-------|
| .py src/ gui.py | pyqt5-desktop |
| .py commander/ | pyqt5-desktop |
