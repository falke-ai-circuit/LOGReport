...
| .py src/ gui.py node_config | [pyqt5-desktop](pyqt5-desktop/SKILL.md) | ⭐ | 75% |
| .py commander/ services/ | [pyqt5-desktop](pyqt5-desktop/SKILL.md) | ⭐ | 75% |
...
| test_* *_test.py tests/ | [testing](testing/SKILL.md) | | 65% |
| .github/skills/* agents/* | [akis-dev](akis-dev/SKILL.md) | | 87% |
| project_knowledge.json | [knowledge](knowledge/SKILL.md) | | 3% |

## Legacy Skills (NOP-specific, kept for reference)
| Situation | Skill | Usage |
|-----------|-------|-------|
| .tsx .jsx components/ pages/ | [frontend-react](frontend-react/SKILL.md) | N/A |
| .py backend/ api/ services/ models/ | [backend-api](backend-api/SKILL.md) | N/A |

⭐ Pre-load for LOGReport: pyqt5-desktop + docker
